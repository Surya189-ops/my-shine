        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <button onClick={() => setPaymentMethod("upi")} className="w-full p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <button
                        ...
                        className={`p-4 border-2 rounded-lg flex flex-col items-center gap-2 transition-all ${selectedUPI === opt.id ? "border-pink-500 bg-pink-50" : "border-gray-200 hover:border-gray-300"}`}
                      >
                        {opt.icon}
            ...
            {/* Card */}
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <button onClick={() => setPaymentMethod("card")} className="w-full p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
            ...
            {/* Net Banking */}
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <button onClick={() => setPaymentMethod("netbanking")} className="w-full p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
            ...
            {/* Wallets */}
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <button onClick={() => setPaymentMethod("wallet")} className="w-full p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
              ...
              {paymentMethod === "wallet" && (
                <div className="border-t p-4 grid grid-cols-2 gap-3">
                  <button className="p-3 border-2 border-gray-200 rounded-lg hover:border-pink-500 transition-colors"><span className="text-sm font-medium">Paytm Wallet</span></button>
                  <button className="p-3 border-2 border-gray-200 rounded-lg hover:border-pink-500 transition-colors"><span className="text-sm font-medium">PhonePe Wallet</span></button>
                </div>
              )}
            </div>
          </div>
